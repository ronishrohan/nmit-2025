  ...
  return (
    <div className="h-fit w-full p-2 flex flex-col">
      ...
      <div className="w-full flex h-[66px] gap-2 items-center">
        <Button className="px-6 shrink-0 h-[calc(100%-4px)]" onClick={() => router.push("/stock-ledger/new-entry")}>
      ...
      <div className="w-full h-fit mt-2 bg-white rounded-xl border-2 border-border ">
            ...
            {filteredStock.map((stock) => (
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  <h2 className="text-xl font-bold text-zinc-800">{stock.product.name}</h2>
        ...
        {!loading && !error && filteredStock.length === 0 && (
          <div className="p-4 text-gray-500">No stock ledger entries found.</div>
        )}
      </div>
    </div>
  );
