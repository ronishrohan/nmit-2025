...
const Page = () => {
  ...
  return (
    <div className="h-fit w-full p-2 flex flex-col">
      {/* Page Title */}
      <div className="mb-4">
        <h1 className="text-3xl font-bold text-zinc-900">Work Orders</h1>
        <p className="text-zinc-600 mt-1">Track and manage individual work orders and their operations</p>
      </div>
